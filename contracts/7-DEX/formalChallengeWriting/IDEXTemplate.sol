...
/**
 * @notice I made this first before the template solidity file. This is an interface of DEX.sol that just outlines what features could be part of the challenge (up to you!)
