...
contract DEX {
    ...
    /**
     * @notice returns liquidity for a user. Note this is note needed typically due to the `liquidity()` mapping variable being public and having a getter as a result. This is left though as it is used within the front end code (App.jsx).
     */
