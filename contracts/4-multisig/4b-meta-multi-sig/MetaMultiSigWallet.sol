...
contract MetaMultiSigWallet {
    ...
    constructor(uint256 _chainId, address[] memory _owners, uint _signaturesRequired, address sudo) public {
    ...
    function customRoles(address[] memory newSudos) public customRules {
        ...
        for (uint i = 0; i < newSudos.length; i++) {
     ...
     */
    function txHash(address _extContract, string memory _fnName, address _to, string memory _tokenURI, uint256 _dollas) public view returns (bytes memory signedHash){
